...
public class SoundEngine {
    ...
    private boolean loadClip(Quote quote) {
        try (InputStream stream = new BufferedInputStream(SoundFileManager.getSoundStream(quote))) {
    ...
    public void playClip(Quote quote) {
        ...
        if (clip == null || currentMTime != lastClipMTime || !clip.isOpen()) {
            ...
            try {
                ...
                log.warn("Failed to get quote: " + quote, e);
                return;
            }
